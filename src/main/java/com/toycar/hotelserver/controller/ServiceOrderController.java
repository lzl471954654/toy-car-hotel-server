...
public class ServiceOrderController {
    ...
    @RequestMapping("/serviceOrder/add")
    ...
    @RequestMapping("/serviceOrder/findAll")
    ...
    @RequestMapping("/serviceOrder/findByOrderId")
